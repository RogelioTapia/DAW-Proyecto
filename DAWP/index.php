...
<body>
		...
		<div class="container-fluid">
			<div class="row main-top-w3l py-2">
				<div class="col-lg-4 header-most-top">
					<p class="text-white text-lg-left text-center">The best online bookstore
				...
				<div class="col-lg-8 header-right mt-lg-0 mt-2">
					...
					<ul>
						...
						<li class="nav-item text-center border-right"><a class="nav-link fas fa-sign-in-alt mr-2 text-white" href="login.php">Log in</a>
						</li>
		...
		<div class="carousel-inner">
					...
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							...
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">
								1 Dollar discount in ALL <span>BOOKS</span>
			...
			<div class="carousel-item item3">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">Big
								<span>BOOKS</span>
							</h3>
							<a class="button2" href="product.html">Shop Now </a>
						</div>
				...
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							...
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">BOOKS
								<span>BOOKS</span>
							</h3>
							<a class="button2" href="product.html">Shop Now </a>
						</div>
	...
	<!-- top Products -->
	<div style="" class="ads-grid py-sm-5 py-4">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4" >
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/m1.jpg" width="300" height="450">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/m2.jpg" width="300" height="450">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/m3.jpg" width="300" height="450">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/m4.jpg" width="300" height="450">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/m5.jpg" width="300" height="450">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/m6.jpg" width="300" height="450">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
			...
			<div class="container py-md-5 py-sm-4 py-3">
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						...
						<ul>
							<li class="mb-3">
								<i class="fas fa-map-marker"></i> 123 Anahuac, Mexico</li>
							<li class="mb-3">
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">2022 Rogelio Tapia | Proyecto final Daw
